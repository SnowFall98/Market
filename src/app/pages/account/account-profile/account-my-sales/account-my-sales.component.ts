...
export class AccountMySalesComponent implements OnInit, OnDestroy {
  ...
  constructor(private ordersService: OrdersService, private salesService: SalesService, private activatedRoute:ActivatedRoute) { }
							...
							for(const f in resp2){
								...
								if(load == Object.keys(resp).length){
									...
									if(this.sales.length > 0){
										...
										Documentación del uso de "reduce"
										=============================================*/
