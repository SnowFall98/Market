...
export class AccountMyStoreComponent implements OnInit, OnDestroy {
  ...
  logoStore: File = null; // Variables para almacenar los archivos de imagen de la tienda
  coverStore: File = null; // Variables para almacenar los archivos de imagen de la tienda
  idStore: string = null; // Variable para capturar el ID de la tienda
  productModel: ProductsModel; // Variable para el modelo de productos
  config = {
    placeholder: '', tabsize: 2, height: '400px', toolbar: [ //Configuración inicial de Summernote
  ...
  summaryGroup: any[] = [{ // Variables de tipo arreglo con objeto para el resumen del producto

    input: ''

  }]
  detailsGroup: any[] = [{ // Variables de tipo arreglo con objetos para los detalles del producto

    title: '',
    value: ''

  }]
  specificationsGroup: any[] = [{ // Variables de tipo arreglo con objetos para las especificaciones del producto
  ...
  editGallery: any[] = []; // Variables de tipo arreglo para la galería del producto
  deleteGallery: any[] = []; // Variables de tipo arreglo para la galería del producto
  ...
  imageProduct: File = null; // Variables para almacenar los archivos de imagen del producto
  topBannerImg: File = null; // Variables para almacenar los archivos de imagen del producto
  defaultBannerImg: File = null; // Variables para almacenar los archivos de imagen del producto
  hSliderImg: File = null; // Variables para almacenar los archivos de imagen del producto
  vSliderImg: File = null; // Variables para almacenar los archivos de imagen del producto
  idProducts: any[] = []; // Variable para capturar el ID del producto
  idProduct: string = null; // Variable para capturar el ID del producto
  editProductAction: boolean = false; // Variable que permite avisar al formulario que estamos editando producto
  popoverMessage: string = 'Are you sure to remove it?'; // Variable que muestra el mensaje antes de borrar el producto


  constructor(private storesService: StoresService, private productsService: ProductsService, private http: HttpClient,
    private usersService: UsersService, private categoriesService: CategoriesService, private subCategoriesService: SubCategoriesService,) {
